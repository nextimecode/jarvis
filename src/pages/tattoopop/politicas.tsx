      ...
      <Box>
        ...
        <VStack pb={4} spacing="2" alignItems="flex-start">
          <Text as="p" fontSize="lg">
            Para receber informações sobre os seus dados pessoais, os propósitos
            e as partes de informação que são compartilhadas, entre em contato
            com o proprietário.
          </Text>
        </VStack>
        <Heading py={4} as="h2">
        ...
        <Text as="p" fontSize="lg">
          ...
          todos os Dados solicitados por este Aplicativo são obrigatórios e a
          falta de fornecimento destes Dados poderá impossibilitar este
          Aplicativo de fornecer os seus Serviços. Nos casos em que este
          Aplicativo afirmar especificamente que alguns Dados não forem
          obrigatórios, os Usuários ficam livres para deixarem de comunicar
          estes Dados sem nenhuma consequência para a disponibilidade ou o
          funcionamento do Serviço. Os Usuários que tiverem dúvidas a respeito
          de quais Dados Pessoais são obrigatórios estão convidados a entrar em
          contato com o Proprietário. Quaisquer usos de cookies – ou de outras
          ferramentas de rastreamento – por este Aplicativo ou pelos
          proprietários de serviços terceiros utilizados por este Aplicativo
          serão para a finalidade de fornecer os Serviços solicitados pelo
          Usuário, além das demais finalidades descritas no presente documento e
          na Política de Cookies, se estiver disponível. Os Usuários ficam
          responsáveis por quaisquer Dados Pessoais de terceiros que forem
          obtidos, publicados ou compartilhados através deste Serviço (este
          Aplicativo) e confirmam que possuem a autorização dos terceiros para
          fornecerem os Dados para o Proprietário.
        </Text>
        <Heading py={4} as="h2">
        ...
        <Text as="p" fontSize="lg">
          ...
          autorizada dos Dados. O processamento dos Dados é realizado utilizando
          computadores e /ou ferramentas de TI habilitadas, seguindo
          procedimentos organizacionais e meios estritamente relacionados com os
          fins indicados. Além do Proprietário, em alguns casos, os Dados podem
          ser acessados por certos tipos de pessoas encarregadas, envolvidas com
          a operação deste Serviço (este Aplicativo) (administração, vendas,
          marketing, administração legal do sistema) ou pessoas externas (como
          fornecedores terceirizados de serviços técnicos, carteiros, provedores
          de hospedagem, empresas de TI, agências de comunicação) nomeadas,
          quando necessário, como Processadores de Dados por parte do
          Proprietário. A lista atualizada destas partes pode ser solicitada ao
        ...
        <Text as="p" fontSize="lg">
          Em qualquer caso, o proprietário colabora de bom grado para esclarecer
          qual a base jurídica que se aplica ao processamento, e em especial se
          o fornecimento de dados for um requisito obrigatório por força de lei
          ou contratual, ou uma exigência necessária para celebrar um contrato.
        </Text>
        <Heading py={4} as="h3" size="lg">
          Lugar
        </Heading>
        <Text as="p" fontSize="lg">
          ...
          estiverem localizadas. Dependendo da localização do usuário as
          transferências de dados poderão envolver a transferência dos Dados do
          Usuário para outro país que não seja o seu. Para descobrirem mais
          sobre o local de processamento de tais Dados transferidos os Usuários
          poderão verificar a seção contendo os detalhes sobre o processamento
          de Dados Pessoais.
        </Text>
        <Text as="p" fontSize="lg">
          Os Usuários também possuem o direito de serem informados sobre a base
          jurídica das transferências de Dados para países de fora da União
          Europeia ou para quaisquer organizações internacionais regidas pelo
          direito internacional público ou formadas por dois ou mais países, tal
          como a ONU, e sobre as medidas de segurança tomadas pelo Proprietário
        ...
        <Text as="p" fontSize="lg">
          ...
          legítimos interesses do Proprietário serão conservados pelo tempo que
          for necessário para cumprir tais finalidades. Os Usuários poderão
          obter informações específicas sobre os interesses legítimos
        ...
        <Text as="p" fontSize="lg">
          ...
          direito de retirar a sua anuência nos casos em que tenham dado a sua
          anuência anteriormente para o processamento dos seus Dados Pessoais.
        </Text>
        <Text as="p" fontSize="lg">
        ...
        <Text as="p" fontSize="lg">
          - Acessar os seus Dados. Os Usuários possuem o direito de saber se os
          seus Dados estão sendo tratados pelo Proprietário, obter revelações
          sobre determinados aspectos do tratamento e conseguir uma cópia dos
          Dados que estiverem sendo tratados.
        </Text>
        <Text as="p" fontSize="lg">
          - Verificar e pedir retificação. Os Usuários possuem o direito de
          verificar a exatidão dos seus Dados e de pedir que os mesmos sejam
        ...
        <Text as="p" fontSize="lg">
          ...
          controlador. Os Usuários possuem o direito de receber os seus Dados em
          um formato estruturado, utilizado comumente e apto a ser lido por
        ...
        <Text as="p" fontSize="lg">
          ...
          determinar se qualquer um dos serviços de terceiros que utilizam
        ...
        <Text as="p" fontSize="lg">
          ...
          de privacidade a qualquer momento, através de notificação a seus
          Usuários nesta página e possivelmente dentro deste Serviço (este
          Aplicativo) e/ou – na medida em que for técnica e juridicamente viável
          – enviando um aviso para os Usuários através de quaisquer informações
          de contato disponíveis para o Proprietário. É altamente recomendável
          checar esta página regularmente, consultando a data da última
          modificação informada na parte inferior.
        </Text>
        <Text as="p" fontSize="lg">
        ...
        <Text as="p" fontSize="lg">
          ...
          entidade que opera este Aplicativo e, conforme for o caso, suas
          controladoras, subsidiárias e afiliadas (para fins desta seção,
          doravante denominadas em conjunto através dos pronomes
          &quot;nós&quot;, &quot;nos&quot;, &quot;nosso&quot; e
          &quot;conosco&quot;).
        </Text>
        <Text as="p" fontSize="lg">
          As disposições contidas nesta seção aplicar-se-ão a todos os Usuários
          que sejam residentes no Brasil, de acordo com a &quot;Lei geral de
          Proteção de Dados&quot; (os Usuários serão doravante denominados
          através dos pronomes &quot;você&quot; e &quot;seu&quot;). Para tais
          Usuários, estas disposições substituem todas as outras disposições
          possivelmente divergentes ou conflitantes contidas nesta política de
          privacidade. Esta parte do documento usa o termo &quot;informações
          pessoais&quot;, conforme definido na Lei Geral de Proteção de Dados
          (LGPD).
        </Text>
        <Heading py={4} as="h3" size="lg">
        ...
        <Text as="p" fontSize="lg">
          - a proteção da saúde – em procedimentos realizados por entidades ou
          profissionais da saúde;
        </Text>
        <Text as="p" fontSize="lg">
          - nossos interesses legítimos, desde que seus direitos e liberdades
          fundamentais não prevaleçam sobre tais interesses;
        </Text>
        <Text as="p" fontSize="lg">
          - proteção ao crédito.
        </Text>
        ...
        <Text as="p" fontSize="lg">
          ...
          detalhadas sobre o processamento de Dados Pessoais&quot; neste
          documento.
        </Text>
        <Heading py={4} as="h3" size="lg">
        ...
        <Text as="p" fontSize="lg">
          Para saber por que processamos suas informações pessoais, você poderá
          ler sobre as seções intituladas &quot;Informações detalhadas sobre o
          processamento de Dados Pessoais&quot; e &quot;As finalidades do
        ...
        <Text as="p" fontSize="lg">
          - obter confirmação sobre a existência de atividades de tratamento de
        ...
        <Text as="p" fontSize="lg">
          - obter informações sobre a possibilidade de fornecer ou recusar sua
          anuência e as respectivas consequências;
        </Text>
        <Text as="p" fontSize="lg">
          - obter informações sobre os terceiros com quem compartilhamos suas
          informações pessoais;
        </Text>
        <Text as="p" fontSize="lg">
          - obter, mediante sua solicitação expressa, a portabilidade de suas
          informações pessoais (exceto informações anônimas) para outro
          fornecedor de produtos ou serviços, desde que nossos segredos
          comerciais e industriais continuem protegidos;
        </Text>
        <Text as="p" fontSize="lg">
          - obter a exclusão de suas informações pessoais tratadas, se o
          tratamento teve base em sua anuência, a menos que se apliquem uma ou
          mais exceções daquelas dispostas no art. 16 da LGPD;
        </Text>
        <Text as="p" fontSize="lg">
          - retirar sua anuência a qualquer momento;
        </Text>
        <Text as="p" fontSize="lg">
          - registrar uma reclamação com relação a suas informações pessoais à
          ANPD (Autoridade Nacional de Proteção de Dados) ou aos órgãos de
          proteção ao consumidor;
        </Text>
        <Text as="p" fontSize="lg">
          - opor-se a uma atividade de tratamento nos casos em que o tratamento
          não for realizado em conformidade com as disposições da lei;
        </Text>
        <Text as="p" fontSize="lg">
          - solicitar informações claras e adequadas a respeito dos critérios e
          procedimentos usados para uma decisão automatizada; e
        </Text>
        <Text as="p" fontSize="lg">
          - solicitar a revisão de decisões tomadas exclusivamente com base no
          tratamento automatizado de suas informações pessoais, que afetem seus
          interesses. Nisto estão incluídas decisões para definir seu perfil
          pessoal, profissional, de consumidor e de crédito ou aspectos de sua
          personalidade.
        </Text>
        <Text as="p" fontSize="lg">
        ...
        <Text as="p" fontSize="lg">
          ...
          Em qualquer caso, caso seja impossível, faremos questão de comunicar a
          você os motivos de fato ou de direito que nos impeçam de atender
          imediatamente, ou de qualquer outra forma, cumprir suas solicitações.
          Nos casos em que não estamos processando suas informações pessoais,
          indicaremos a pessoa física ou jurídica a quem você deve encaminhar
          suas solicitações, se estivermos na posição de fazê-lo. Caso você
          registre uma solicitação de acesso ou de confirmação de processamento
          de informações pessoais, certifique-se de especificar se deseja que
          suas informações pessoais sejam entregues em formato eletrônico ou
          impresso. Você também precisará nos informar se deseja que respondamos
          sua solicitação imediatamente, sendo que neste caso responderemos de
          maneira simplificada ou se você precisa de uma resposta completa.
          Neste último caso, responderemos no prazo de 15 dias a contar do
          momento de sua solicitação, fornecendo todas as informações sobre a
          origem de suas informações pessoais, confirmação da existência ou não
          de registros, quaisquer critérios utilizados para o processamento e as
          ...
          exclusão, anonimato ou bloqueio de informações pessoais, comunicaremos
          imediatamente sua solicitação a outras partes com quem compartilhamos
          suas informações pessoais, a fim de permitir que estes terceiros
          também cumpram sua solicitação – exceto nos casos em que tal
          comunicação se provar impossível ou envolver um esforço
          desproporcional de nosso lado.
        </Text>
        <Heading py={4} as="h3" size="lg">
          Transferência de informações pessoais para fora do Brasil permitida
          por lei
        </Heading>
        <Text as="p" fontSize="lg">
          Temos permissão para transferir suas informações pessoais para fora do
          território brasileiro nos seguintes casos:
        </Text>
        <Text as="p" fontSize="lg">
        ...
        <Text as="p" fontSize="lg">
          - uando a transferência for necessária para o cumprimento de uma
          obrigação legal ou regulamentar, a execução de um contrato ou
          procedimentos preliminares relacionados a um contrato ou o exercício
          regular de direitos em processos judiciais, administrativos ou de
          arbitragem.
        </Text>
      </Box>
    </Container>
