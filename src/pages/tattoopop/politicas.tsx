...
const Politicas = () => {
  return (
    <NextLayout
      title={'Política de Privacidade | TattooPop'}
      description={
        'Conheça nossa política de privacidade e saiba como seus dados pessoais são coletados, utilizados e protegidos em nosso aplicativo.'
      }
        ...
        <Box>
          ...
          <VStack pb={4} spacing="2" alignItems="flex-start">
            <Text as="p" fontSize="lg">
              ...
              propósitos e as partes de informação que são compartilhadas, entre
          ...
          <Text as="p" fontSize="lg">
            ...
            de quais Dados Pessoais são obrigatórios estão convidados a entrar
            em contato com o Proprietário. Quaisquer usos de cookies – ou de
            outras ferramentas de rastreamento – por este Aplicativo ou pelos
            ...
            Usuário, além das demais finalidades descritas no presente documento
            e na Política de Cookies, se estiver disponível. Os Usuários ficam
          ...
          <Text as="p" fontSize="lg">
            ...
            encarregadas, envolvidas com a operação deste Serviço (este
            Aplicativo) (administração, vendas, marketing, administração legal
            do sistema) ou pessoas externas (como fornecedores terceirizados de
            serviços técnicos, carteiros, provedores de hospedagem, empresas de
            TI, agências de comunicação) nomeadas, quando necessário, como
          ...
          <Text as="p" fontSize="lg">
            ...
            legislações o Proprietário poderá ter a permissão para processar os
            Dados Pessoais ATÉ QUE O Usuário faça objeção a isto (“opt-out”),
            sem ter que se basear em anuência ou em quaisquer outras bases
            jurídicas a seguir. Isto contudo não se aplica sempre que o
            processamento de Dados Pessoais estiver sujeito à legislação
          ...
          <Text as="p" fontSize="lg">
            Em qualquer caso, o proprietário colabora de bom grado para
          ...
          <Text as="p" fontSize="lg">
            ...
            os legítimos interesses do Proprietário serão conservados pelo tempo
          ...
          <Text as="p" fontSize="lg">
            ...
            revelações sobre determinados aspectos do tratamento e conseguir uma
            cópia dos Dados que estiverem sendo tratados.
          </Text>
          <Text as="p" fontSize="lg">
          ...
          <Text as="p" fontSize="lg">
            ...
            controlador. Os Usuários possuem o direito de receber os seus Dados
            em um formato estruturado, utilizado comumente e apto a ser lido por
            máquinas e, se for viável tecnicamente, fazer com que os mesmos
            sejam transmitidos para outro controlador sem nenhum empecilho. Esta
          ...
          <Text as="p" fontSize="lg">
            ...
            estar ciente de que o Proprietário poderá ser obrigado a revelar os
            Dados Pessoais mediante solicitação das autoridades governamentais.
          </Text>
          <Heading py={4} as="h3" size="lg">
          ...
          <Text as="p" fontSize="lg">
            As disposições contidas nesta seção aplicar-se-ão a todos os
            Usuários que sejam residentes no Brasil, de acordo com a &quot;Lei
            geral de Proteção de Dados&quot; (os Usuários serão doravante
            denominados através dos pronomes &quot;você&quot; e
            &quot;seu&quot;). Para tais Usuários, estas disposições substituem
            todas as outras disposições possivelmente divergentes ou
            conflitantes contidas nesta política de privacidade. Esta parte do
            documento usa o termo &quot;informações pessoais&quot;, conforme
          ...
          <Text as="p" fontSize="lg">
            ...
            poderá ler sobre as seções intituladas &quot;Informações detalhadas
            sobre o processamento de Dados Pessoais&quot; e &quot;As finalidades
            do processamento&quot; neste documento.
          </Text>
          <Heading py={4} as="h3" size="lg">
          ...
          <Text as="p" fontSize="lg">
            ...
            tratamento não for realizado em conformidade com as disposições da
            lei;
          </Text>
          <Text as="p" fontSize="lg">
            - solicitar informações claras e adequadas a respeito dos critérios
            e procedimentos usados para uma decisão automatizada; e
          </Text>
          <Text as="p" fontSize="lg">
            - solicitar a revisão de decisões tomadas exclusivamente com base no
            tratamento automatizado de suas informações pessoais, que afetem
            seus interesses. Nisto estão incluídas decisões para definir seu
            perfil pessoal, profissional, de consumidor e de crédito ou aspectos
          ...
          <Text as="p" fontSize="lg">
            ...
            solicitações. Nos casos em que não estamos processando suas
