  ...
  return (
    <Container maxW={'container.lg'}>
      <Box>
        ...
        <Text as="p" fontSize="lg">
          Os Dados Pessoais poderão ser fornecidos livremente pelo Usuário, ou, no caso dos Dados de
          Utilização, coletados automaticamente ao se utilizar este Aplicativo. A menos que
          especificado diferentemente todos os Dados solicitados por este Aplicativo são
          obrigatórios e a falta de fornecimento destes Dados poderá impossibilitar este Aplicativo
          de fornecer os seus Serviços. Nos casos em que este Aplicativo afirmar especificamente que
          alguns Dados não forem obrigatórios, os Usuários ficam livres para deixarem de comunicar
          estes Dados sem nenhuma consequência para a disponibilidade ou o funcionamento do Serviço.
          Os Usuários que tiverem dúvidas a respeito de quais Dados Pessoais são obrigatórios estão
          convidados a entrar em contato com o Proprietário. Quaisquer usos de cookies – ou de
          outras ferramentas de rastreamento – por este Aplicativo ou pelos proprietários de
          serviços terceiros utilizados por este Aplicativo serão para a finalidade de fornecer os
          Serviços solicitados pelo Usuário, além das demais finalidades descritas no presente
          documento e na Política de Cookies, se estiver disponível. Os Usuários ficam responsáveis
          por quaisquer Dados Pessoais de terceiros que forem obtidos, publicados ou compartilhados
          através deste Serviço (este Aplicativo) e confirmam que possuem a autorização dos
        ...
        <Text as="p" fontSize="lg">
          ...
          autorizado, divulgação, alteração ou destruição não autorizada dos Dados. O processamento
          dos Dados é realizado utilizando computadores e /ou ferramentas de TI habilitadas,
          seguindo procedimentos organizacionais e meios estritamente relacionados com os fins
          indicados. Além do Proprietário, em alguns casos, os Dados podem ser acessados por certos
          tipos de pessoas encarregadas, envolvidas com a operação deste Serviço (este Aplicativo)
          (administração, vendas, marketing, administração legal do sistema) ou pessoas externas
          (como fornecedores terceirizados de serviços técnicos, carteiros, provedores de
          hospedagem, empresas de TI, agências de comunicação) nomeadas, quando necessário, como
          Processadores de Dados por parte do Proprietário. A lista atualizada destas partes pode
        ...
        <Text as="p" fontSize="lg">
          ...
          processar os Dados Pessoais ATÉ QUE O Usuário faça objeção a isto (“opt-out”), sem ter que
          se basear em anuência ou em quaisquer outras bases jurídicas a seguir. Isto contudo não se
          aplica sempre que o processamento de Dados Pessoais estiver sujeito à legislação europeia
          de proteção de dados;
        </Text>
        <Text as="p" fontSize="lg">
          - O fornecimento dos Dados for necessário para o cumprimento de um contrato com o Usuário
          e/ou quaisquer obrigações pré-contratuais do mesmo;
        </Text>
        <Text as="p" fontSize="lg">
        ...
        <Text as="p" fontSize="lg">
          ...
          lugares onde as partes envolvidas com o processamento estiverem localizadas. Dependendo da
          localização do usuário as transferências de dados poderão envolver a transferência dos
          Dados do Usuário para outro país que não seja o seu. Para descobrirem mais sobre o local
          de processamento de tais Dados transferidos os Usuários poderão verificar a seção contendo
          os detalhes sobre o processamento de Dados Pessoais.
        </Text>
        <Text as="p" fontSize="lg">
        ...
        <Text as="p" fontSize="lg">
          - Os Dados Pessoais coletados para as finalidades relacionadas com os legítimos interesses
          do Proprietário serão conservados pelo tempo que for necessário para cumprir tais
          finalidades. Os Usuários poderão obter informações específicas sobre os interesses
        ...
        <Text as="p" fontSize="lg">
          ...
          direito de acessar, o direito de apagar, o direito de corrigir e o direito à portabilidade
          dos dados não poderão ter o seu cumprimento exigido após o vencimento do prazo de
          conservação.
        </Text>
        <Heading py={4} as="h3" size="lg">
        ...
        <Text as="p" fontSize="lg">
          - Verificar e pedir retificação. Os Usuários possuem o direito de verificar a exatidão dos
        ...
        <Text as="p" fontSize="lg">
          ...
          determinadas circunstâncias, restringir o processamento dos seus Dados para qualquer outra
          finalidade que não seja o armazenamento dos mesmos.
        </Text>
        <Text as="p" fontSize="lg">
          - Ter os seus Dados Pessoais apagados ou retirados de outra maneira. Os Usuários possuem o
          direito de, sob determinadas circunstâncias, obter a eliminação dos seus Dados do
          Proprietário.
        </Text>
        <Text as="p" fontSize="lg">
          - Receber os seus Dados e ter os mesmos transferidos para outro controlador. Os Usuários
          possuem o direito de receber os seus Dados em um formato estruturado, utilizado comumente
          e apto a ser lido por máquinas e, se for viável tecnicamente, fazer com que os mesmos
          sejam transmitidos para outro controlador sem nenhum empecilho. Esta determinação se
          aplica condicionada a que os Dados sejam processados por meios automatizados e que o
          processamento esteja baseado na anuência do Usuário, em um contrato do qual o Usuário seja
          uma das partes ou por obrigações pré-contratuais do mesmo.
        </Text>
        <Text as="p" fontSize="lg">
          - Registrar uma reclamação. Os Usuários possuem o direito de apresentar reclamação perante
        ...
        <Text as="p" fontSize="lg">
          Os Dados Pessoais dos Usuários podem ser utilizados para fins jurídicos pelo Proprietário
          em juízo ou nas etapas conducentes à possível ação jurídica decorrente de uso indevido
          deste Serviço (este Aplicativo) ou dos Serviços relacionados. O Usuário declara estar
          ciente de que o Proprietário poderá ser obrigado a revelar os Dados Pessoais mediante
          solicitação das autoridades governamentais.
        </Text>
        <Heading py={4} as="h3" size="lg">
        ...
        <Text as="p" fontSize="lg">
          ...
          fornecer ao Usuário informações adicionais e contextuais sobre os serviços específicos ou
          a coleta e processamento de Dados Pessoais mediante solicitação.
        </Text>
        <Heading py={4} as="h3" size="lg">
          Informações adicionais sobre os Dados Pessoais do Usuário
        </Heading>
        ...
        <Text as="p" fontSize="lg">
          ...
          dos serviços de terceiros que utilizam honram solicitações de “Não Me Rastreie”, por favor
        ...
        <Text as="p" fontSize="lg">
          ...
          dentro deste Serviço (este Aplicativo) e/ou – na medida em que for técnica e juridicamente
          viável – enviando um aviso para os Usuários através de quaisquer informações de contato
          disponíveis para o Proprietário. É altamente recomendável checar esta página regularmente,
          consultando a data da última modificação informada na parte inferior.
        </Text>
        <Text as="p" fontSize="lg">
          Caso as mudanças afetem as atividades de processamento realizadas com base na anuência do
          Usuário, o Proprietário coletará nova anuência do Usuário, onde for exigida.
        </Text>
        <Heading py={4} as="h3" size="lg">
        ...
        <Text as="p" fontSize="lg">
          ...
          política de privacidade e é fornecida pela entidade que opera este Aplicativo e, conforme
          for o caso, suas controladoras, subsidiárias e afiliadas (para fins desta seção, doravante
          denominadas em conjunto através dos pronomes &quot;nós&quot;, &quot;nos&quot;,
          &quot;nosso&quot; e &quot;conosco&quot;).
        </Text>
        <Text as="p" fontSize="lg">
          As disposições contidas nesta seção aplicar-se-ão a todos os Usuários que sejam residentes
          no Brasil, de acordo com a &quot;Lei geral de Proteção de Dados&quot; (os Usuários serão
          doravante denominados através dos pronomes &quot;você&quot; e &quot;seu&quot;). Para tais
          Usuários, estas disposições substituem todas as outras disposições possivelmente
          divergentes ou conflitantes contidas nesta política de privacidade. Esta parte do
          documento usa o termo &quot;informações pessoais&quot;, conforme definido na Lei Geral de
        ...
        <Text as="p" fontSize="lg">
          - o cumprimento de políticas públicas dispostas em leis ou regulamentações ou com base em
          contratos, acordos e instrumentos legais semelhantes;
        </Text>
        <Text as="p" fontSize="lg">
        ...
        <Text as="p" fontSize="lg">
          Para saber que categorias de suas informações pessoais são processadas, você poderá ler a
          seção intitulada &quot;Informações detalhadas sobre o processamento de Dados
        ...
        <Text as="p" fontSize="lg">
          Para saber por que processamos suas informações pessoais, você poderá ler sobre as seções
          intituladas &quot;Informações detalhadas sobre o processamento de Dados Pessoais&quot; e
          &quot;As finalidades do processamento&quot; neste documento.
        </Text>
        <Heading py={4} as="h3" size="lg">
        ...
        <Text as="p" fontSize="lg">
          - obter o anonimato, bloqueio ou eliminação de suas informações pessoais desnecessárias ou
          em excesso, ou de informações que não estejam sendo processadas de acordo com a LGPD;
        </Text>
        <Text as="p" fontSize="lg">
        ...
        <Text as="p" fontSize="lg">
          - obter a exclusão de suas informações pessoais tratadas, se o tratamento teve base em sua
          anuência, a menos que se apliquem uma ou mais exceções daquelas dispostas no art. 16 da
          LGPD;
        </Text>
        <Text as="p" fontSize="lg">
        ...
        <Text as="p" fontSize="lg">
          - opor-se a uma atividade de tratamento nos casos em que o tratamento não for realizado em
          conformidade com as disposições da lei;
        </Text>
        <Text as="p" fontSize="lg">
          - solicitar informações claras e adequadas a respeito dos critérios e procedimentos usados
          para uma decisão automatizada; e
        </Text>
        <Text as="p" fontSize="lg">
        ...
        <Text as="p" fontSize="lg">
          Você poderá registrar sua solicitação expressa de exercer seus direitos gratuitamente , em
          qualquer momento, usando os dados de contato fornecidos neste documento ou através de seu
          representante legal.
        </Text>
        <Heading py={4} as="h3" size="lg">
        ...
        <Text as="p" fontSize="lg">
          ...
          caso seja impossível, faremos questão de comunicar a você os motivos de fato ou de direito
          que nos impeçam de atender imediatamente, ou de qualquer outra forma, cumprir suas
          solicitações. Nos casos em que não estamos processando suas informações pessoais,
          indicaremos a pessoa física ou jurídica a quem você deve encaminhar suas solicitações, se
          estivermos na posição de fazê-lo. Caso você registre uma solicitação de acesso ou de
          ...
          permitir que estes terceiros também cumpram sua solicitação – exceto nos casos em que tal
          comunicação se provar impossível ou envolver um esforço desproporcional de nosso lado.
        </Text>
        <Heading py={4} as="h3" size="lg">
        ...
        <Text as="p" fontSize="lg">
          ...
          entre órgãos públicos de inteligência, investigação e Ministério Público, de acordo com os
          meios legais dispostos no direito internacional;
        </Text>
        <Text as="p" fontSize="lg">
        ...
        <Text as="p" fontSize="lg">
          ...
          contrato ou o exercício regular de direitos em processos judiciais, administrativos ou de
          arbitragem.
        </Text>
      </Box>
    </Container>
