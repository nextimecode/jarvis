            ...
            <Box>
              <List spacing={3}>
                ...
                <ListItem>
                  ...
                  utilização de forma fraudulenta, bem como que tentativa ou violação destes Termos
                  ou quaisquer legislações vigentes.
                </ListItem>
              </List>
            </Box>
            <Heading py={4} as="h2">
            ...
            <Box>
              <List spacing={3}>
                  ...
                  <List spacing={3}>
                    <ListItem>
                      <Text fontWeight={'bold'}>
                        3.1 O app e suas funcionalidades são apresentados a você na maneira como
                        estão disponíveis no momento, podendo passar por constantes melhorias e
                        atualizações, obrigando-se a Tattoo Pop a:{' '}
                      </Text>
                    </ListItem>
                    <ListItem>
                      I. Preservar a sua funcionalidade, com links não bloqueados e utilizando
                      layout que facilita a usabilidade e navegabilidade, sempre que possível,
                      exibindo as funcionalidades de maneira clara, completa, precisa e suficiente
                      de modo que você possa perceber as operações realizadas, protegendo, por meio
                      do estado da técnica disponível, os dados coletados pelas funcionalidades
                      disponibilizadas.
                    </ListItem>
                  </List>
                </ListItem>
                <ListItem>
                  ...
                  A Tattoo Pop coloca os seus esforços para a manutenção da disponibilidade contínua
                  e permanente do app. No entanto, pode ocorrer, eventualmente, alguma
                  indisponibilidade temporária, que pode decorrer de manutenção necessária, ou em
                  casos de força maior, com falhas nos sistemas de comunicação e acesso à Internet
                  ou fatos de terceiro que fogem da esfera de vigilância e responsabilidade do
                  usuário.
                </ListItem>
                <ListItem>
                  <Text py={4} as="span" fontWeight={'bold'}>
                  ...
                  Se isso ocorrer, a Tattoo Pop fará o que estiver ao seu alcance para restabelecer
                  o acesso ao site/app o mais breve possível, dentro das limitações técnicas de seus
            ...
            <Box>
              <List spacing={3}>
                <ListItem>
                  ...
                  Você como usuário se compromete a não acessar áreas de programação do site/app,
                  seu banco de dados, códigos fonte ou qualquer outro conjunto de dados disponíveis
                  nestes ambientes, de modo que não realize ou permita realizar engenharia reversa,
                ...
                <ListItem>
                  ...
                  Você deverá manter o sigilo dos dados de sua Conta de Acesso em relação a
                  terceiros e utilizá-la de modo individual e intransferível, de modo que não
                  disponibilize, divulgue e compartilhe sua senha ou qualquer mecanismo de
                  autenticação com quem quer que seja. Em casos de suspeita de violação de conta,
                  você deverá proceder com a troca e atualização o mais rápido possível.
                </ListItem>
              </List>
            </Box>
            <Heading py={4} as="h2">
            ...
            <Box>
              <List spacing={3}>
                ...
                <ListItem>
                  ...
                  app em qualquer idioma ou forma, são de propriedade da Tattoo Pop ou licenciadas.
                  O uso do site/app não gera qualquer presunção de transferência dessa propriedade
                  ou licença.
                </ListItem>
                <ListItem>
                  <Text py={4} as="span" fontWeight={'bold'}>
                  ...
                  Alegações de violação de direito autoral ou de outra natureza devem ser
                  encaminhadas ao representante indicado pela Tattoo Pop no endereço
            ...
            <Box>
              <List spacing={3}>
                <ListItem>
                  ...
                  regula o tratamento dos dados coletados no app, sendo parte integrante e
            ...
            <Box>
              <List spacing={3}>
                <ListItem>
                  ...
                  Você deve arcar com os meios necessários para navegar no site/app, incluindo a
                ...
                <ListItem>
                  ...
                  <List spacing={3}>
                    ...
                    <ListItem>
                      ...
                      disponibilizados em tais links para serviços de terceiros, não sendo,
                      portanto, responsáveis por prejuízos, perdas ou danos ocorridos pela visita
                      dos sites, de forma que cabe ao interessado verificar a confiabilidade das
            ...
            <Box>
              <List spacing={3}>
                ...
                <ListItem>
                  ...
                  constituirá renúncia ou novação nem impedirá a Tattoo Pop de exigir estas
                  condições a qualquer tempo.
                </ListItem>
                <ListItem>
                  <Text py={4} as="span" fontWeight={'bold'}>
                    8.3. Nulidade.{' '}
            ...
            <Box>
              <List spacing={3}>
                <ListItem>
                  ...
                  inexequível total ou parcialmente, por qualquer legislação, essa disposição ou
                  parte dela será, naquela medida, considerada como não existente para os efeitos
                  destes Termos, mas a legalidade, validade e exequibilidade das demais disposições
                  contidas nestes Termos não serão afetadas.
                </ListItem>
                <ListItem>
                  <Text py={4} as="span" fontWeight={'bold'}>
                    9.2.{' '}
                  </Text>
                  Nesse caso, as partes substituirão a disposição ilegal, inválida ou inexequível,
                  ou parte dela, por outra que seja legal, válida e exequível e que, na máxima
                  medida possível, tenha efeito similar à disposição tida como ilegal, inválida ou
                ...
                <ListItem>
                  ...
                  Estes Termos constituem a totalidade do acordo e entendimento das partes sobre
                  este assunto e substituem e prevalecem sobre todos os entendimentos e compromissos
